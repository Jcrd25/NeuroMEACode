function [GammaPower,HighGamma,LowGamma] = MEA_GammaPCalc(MEAData,ChannelNumber)
...
[Power, Frequency ] = M_AverageFFT( MEAData.RawData.DownSampledData(:,ChannelNumber), MEAData.Settings.InfoChannel.Label(ChannelNumber), MEAData.Settings.FileName, SamplingRate, 'N');
