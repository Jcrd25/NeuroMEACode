function MEAData = HDF5_NC_MEA_data_structuremaker_v2(HDF5DataFile)
...
Temp = struct;
    ...
    [MEAData.RawData.VoltageTrace, MEAData.RawData.SamplingRate] = M_downsampler(VoltageTrace, 20000, 20000);
