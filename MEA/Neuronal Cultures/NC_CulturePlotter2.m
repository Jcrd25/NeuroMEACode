function NC_CulturePlotter2(CultureData,DIV,SavingInfo)
...
for CultureID = 1:NumberOfCultures
    for DayID = 1:NumberOfDays
        ...
        for Chan = 1:NumChannels
            if CultureData(CultureID).DIV(DayID).PeakData(Chan).SpikeNum > 1
...
% + = [ColumnHeader; RowHeader num2cell(AverageInstSpikeFreq')];
% 
